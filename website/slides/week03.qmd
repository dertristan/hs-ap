...
- **Elites** (legislators, activists): divergence since the 1970s is not disputed [@fiorina2008political]
...
Mention the Annual Review: same side as the reply, longer. We use it in the last block.
:::
...
- Optional: @fiorina2008political, the Annual Review version of Fiorina's side
...
::: {.small}
| Share with consistently liberal or conservative views (%) | 1982 to 1990 | 1992 to 2000 | 2002 to 2004 |
|---|---:|---:|---:|
| All respondents | 24 | 29 | 33 |
| Nonvoters | 18 | 19 | 19 |
| High knowledge | 38 | 43 | 48 |
| College graduates | 36 | 43 | 49 |

: Share of respondents with consistently liberal or consistently conservative positions across seven issues, by decade. Selected rows from @abramowitz2008ispolarization, Table 1. {#tbl-as-consistency}
:::
...
Ask: is the most engaged panel bimodal? Look at it: mass on both sides, a dip at the middle.
Most engaged third = 37% of respondents, close to half of voters.
:::

:::: {.columns}

::: {.column width="45%"}
![Distribution of 2004 NES respondents on an 11-point liberal-conservative policy scale. The least engaged third (A) clusters in the middle, the most engaged third (B) spreads towards both ends. *Source:* @abramowitz2008ispolarization, Figure 1.](images/week03-as2008-fig1.png){#fig-as-engaged fig-align="center" height="400"}
:::

::: {.column width="55%"}
- Least engaged third: mean 6.1, SD **1.5**
- Most engaged third: mean 6.2, SD **2.8**
- Consistent liberals or conservatives
  - Least engaged: 13% and 19%
  - Most engaged: 32% and 39%
- The engaged third is 37% of respondents and close to half of all voters
:::
...
::: {.column width="55%"}
![Correlation of party identification with liberal-conservative identification in the NES, 1972 to 2004. It rises from .32 to .63, most steeply after 1992. *Source:* @abramowitz2008ispolarization, Figure 3.](images/week03-as2008-fig3.png){#fig-as-correlation fig-align="center"}
:::

::: {.column width="45%"}
- r = .32 in 1972, .44 in 1992, **.63** in 2004
- Among the engaged: .47 to .77
- The gap between Democratic and Republican mean ideology doubles, 0.9 to 1.8 points
:::
...
These are the results FAP say are not evidence of polarization. Hold that thought.
:::

- **Geography:** battleground states fall from 24 in 1960 to 12 in 2004
...
- Their longer case is in @fiorina2008political

## Theory {#sec-fap-theory .smaller}

::: notes
Walk the figure. Same voters, normally distributed on two dimensions.
Left: candidates differ on economics, the vote splits on economics. Right: they differ on morals, the vote splits on morals.
...
::: {.column width="45%"}
- **Polarization** = movement from the centre towards the extremes
- **Sorting** is something else: party groups grow more distinct while the overall distribution stays put
- Centrist voters make polarized choices when the candidates polarize
:::

::: {.column width="55%"}
![A spatial model with the same voters in both panels. When the candidates differ on the economic dimension (left), the vote divides voters along it. When they differ on the moral dimension (right), the same voters divide along that one instead. *Source:* @fiorina2008political, Figure 7.](images/week03-fa2008-fig7.png){#fig-fa-spatial fig-align="center"}
:::
...
::: {.column width="50%"}
![Average percentage point difference between Republican and Democratic identifiers on 40 questions, 1987 to 2007. It grows from 10 to 14 points. *Source:* @fiorina2008polarization, Figure 1, from Pew Research Center data.](images/week03-fap2008-fig1.png){#fig-fap-pew fig-align="center"}
:::

::: {.column width="50%"}
- Party sorting "certainly has occurred", but far less than among elites
- Abortion, 2004: a third of strong Democrats and two fifths of strong Republicans break with their party
- Red vs blue states: majorities disagree on **one** NES issue
- 2004 turnout: the parties' ground game, not polarization (party contacts up 8 points)
:::
...
## One side's definition {#sec-fa-definition .smaller}

::: notes
The top of each figure is the polarized case.
Figure 2: both bimodal, but only the bottom has its modes at the extremes.
Level vs trend: judging a level is contested, a move from top to bottom is a polarizing trend.
Caveat out loud: this is Fiorina's own definition. It builds in his side of the debate.
:::

:::: {.columns}

::: {.column width="50%"}
![Two hypothetical distributions on a liberal-conservative scale. The top one is bimodal and counts as polarized, the bottom one is not. *Source:* @fiorina2008political, Figure 1.](images/week03-fa2008-fig1.png){#fig-fa-bimodal fig-align="center" height="300"}
:::

::: {.column width="50%"}
![Two bimodal distributions on a seven-point scale. Only the bottom one has its modes at the extremes. *Source:* @fiorina2008political, Figure 2.](images/week03-fa2008-fig2.png){#fig-fa-levels fig-align="center" height="200"}
:::

::::

- Polarization = bimodality with the modes **at the extremes**, and a trend away from the centre
- Not neutral: this is **one side's** definition of the term under dispute
...
::: {.callout-important}
**"Is the public polarized?" has no answer until you say which polarization.**
